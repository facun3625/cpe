    ...
    <div>
      ...
      <form action={guardarPropuestaEducativa} className="mt-6 max-w-2xl space-y-5">
        ...
        <Field label="Bajada corta">
          <TextInput name="intro" required defaultValue={c.intro} />
        </Field>
        <Field label="Párrafos (uno por línea)">
          <TextArea name="parrafos" rows={6} defaultValue={c.parrafos.join("\n")} />
        </Field>
        <Field label="Firma">
          <TextInput name="firma" defaultValue={c.firma} />
        </Field>
        <SubmitButton>Guardar cambios</SubmitButton>
      </form>

      <div className="mt-10 grid gap-4 sm:grid-cols-2">
        <a href="/admin/secciones/actividad-academica" className="rounded-2xl border border-slate-200 bg-white p-6 transition hover:-translate-y-1 hover:shadow-lg">
        ...
        <a href="/admin/biblioteca" className="rounded-2xl border border-slate-200 bg-white p-6 transition hover:-translate-y-1 hover:shadow-lg">
