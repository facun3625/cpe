        ...
        return (
          <div key={item.title}>
            <button
              ...
              className="flex w-full cursor-pointer items-center justify-between gap-4 px-6 py-5 text-left transition hover:bg-cpe-bg/60"
            >
              <span className="font-bold text-cpe-navy">{item.title}</span>
